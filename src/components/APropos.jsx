...
const APropos = () => {
  return (
    <section className='a_propos_section'>
        ...
        <h2 className='a_propos_title'>Qui suis-je ?</h2>
        ...
        <section className='a_propos_description'>
        <h2 className='a_propos_title'>Mon parcours</h2>
        ...
        <section className='a_propos_description'>
            <h2 classname='a_propos_title'>Mon expertise</h2>
            <p>e suis spécialisé dans le développement front-end, avec une expertise particulière en HTML, CSS, JavaScript, et des frameworks modernes comme Next.js et React. Mon objectif est de créer des interfaces utilisateur qui allient esthétique, fluidité, et performance.</p>
        </section>
        <section className='a_propos_description'>
            <h2 classname='a_propos_title'>Mes valeurs</h2>
        ...
        <section className='a_propos_description'>
            <h2 classname='a_propos_title'>Mon approche</h2>
        ...
        <section className='a_propos_description'>
            <h2 classname='a_propos_title'>Mes réalisations</h2>
        ...
        <section className='a_propos_description'>
            <h2 classname='a_propos_title'>Pourquoi me choisir ?</h2>
